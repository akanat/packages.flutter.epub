...
class EpubController {
  ...
  void jumpToAddress({required Map<String, dynamic> address}) => _epubViewState?._itemScrollController?.jumpTo(
        index: address['itemIndex'] as int,
        alignment: address['itemLeadingEdge'] as double,
      );
  ...
  Map<String, dynamic>? getAbsoluteStartAddress() {
    return _epubViewState?._currentAbsoluteStartValue?.toJson();
  }

  Map<String, dynamic>? getAbsoluteCenterAddress() {
    return _epubViewState?._currentAbsoluteCenterValue?.toJson();
  }

  Map<String, dynamic>? getAbsoluteEndAddress() {
    return _epubViewState?._currentAbsoluteEndValue?.toJson();
  }

  Future<List<ParagraphViewport>?> getContentWithViewport() async {
    List<ParagraphViewport>? result = await _epubViewState?.getContentWithViewport();
    return result;
  }
